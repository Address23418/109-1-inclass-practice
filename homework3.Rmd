...
as.factor(Info_UserData$user_grade)
...
#print(User_Counts_with_gender_NA)
```
...
```{r ans13}
# Users_E
a <- Info_UserData$user_grade <= 6
b <-is.na(Info_UserData$gender)

Users_E <- Info_UserData$uuid[a&b]
...
c <-Info_UserData$user_grade%in%c(1,3,5)
Users_E_in_odd_grades <- Info_UserData$uuid[c&b]
#print(Users_E_in_odd_grades)
...
```{r ans15}
# Users_E_Not_Metro 
Info_UserData$user_city[c("tp","ntpc","ty","tc","tn","kh")]
```
