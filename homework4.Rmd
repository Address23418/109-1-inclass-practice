...
ntpuLogoRaster[2:182,1] <- "red"
ntpuLogoRaster[2:182,300] <- "red"

ntpuLogoRaster_redFrame <- as.raster(ntpuLogoRaster) 
...
{ ntpuLogoRaster <- as.matrix(ntpuLogoRaster)
  b <- str_which(ntpuLogoRaster,"[transparent]")
