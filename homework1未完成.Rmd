...
NBA1920Final567 <- list("5"=Game5,"6"=Game6,"7"=Game7)           
...
```{r ans13}
# G5TimeParsed
Game5Time.<-c("2020",Game5Time[[2]],Game5Time[[1]])
G5TimeParsed <- paste0(Game5Time.[[3]]," ",Game5Time.[[1]]," ",Game5Time.[[2]])
```
...
```{r ans15}
#ParisLouis
LouisBackTime <- mdy_hms("Oct.09,2020,21::00",tz="America/New_York")
...
dearStudent <- paste0(sen1,sen2,sen3)
